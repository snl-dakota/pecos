		  ...
		  int coeff_2)
{
  ...
  //    append_mi_map
  SizetSet&         sparse_ind = sparseIndices[key];
  SizetSet combined_sparse_ind = sparse_ind; // copy
  StSCIter cit;
  ...
  sparse_ind = combined_sparse_ind;
  if (expansionCoeffFlag) expCoeffsIter->second = combined_exp_coeffs;
  if (expansionCoeffGradFlag)
    expCoeffGradsIter->second = combined_exp_coeff_grads;
}
