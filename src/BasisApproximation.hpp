...
public:
  ...
  virtual void combine_coefficients(short corr_type);
...
private:
  ...
  BasisApproximation* get_basis_approx(short basis_type,
    const UShortArray& approx_order, size_t num_vars, bool use_derivs);
