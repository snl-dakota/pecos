...
enum { DESIGN, STD_NORMAL, NORMAL, BOUNDED_NORMAL, LOGNORMAL, BOUNDED_LOGNORMAL,
       ...
       HISTOGRAM_BIN, HISTOGRAM_POINT, INTERVAL, STATE };

// define special values for secondaryACVarMapTargets/secondaryADVarMapTargets
enum { NO_TARGET, CDV_LWR_BND, CDV_UPR_BND, DDRV_LWR_BND, DDRV_UPR_BND,
       ...
       CSV_LWR_BND, CSV_UPR_BND, DSRV_LWR_BND, DSRV_UPR_BND };
