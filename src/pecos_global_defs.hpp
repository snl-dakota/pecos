...
enum { DESIGN, STD_NORMAL, NORMAL, BOUNDED_NORMAL, LOGNORMAL, BOUNDED_LOGNORMAL,
       STD_UNIFORM, PIECEWISE_STD_UNIFORM, UNIFORM, LOGUNIFORM, TRIANGULAR,
       STD_EXPONENTIAL, EXPONENTIAL, STD_BETA, BETA, STD_GAMMA, GAMMA, GUMBEL,
       FRECHET, WEIBULL, HISTOGRAM_BIN, HISTOGRAM_POINT, STOCHASTIC_EXPANSION,
       INTERVAL, STATE };
...
enum { /* NO_POLY, */ HERMITE_ORTHOG, LEGENDRE_ORTHOG, LAGUERRE_ORTHOG,
...
/// integration rules within VPISparseGrid (1-11: CC through HGK,
/// excluding Newton-Cotes)
enum { CLENSHAW_CURTIS=1, FEJER2, GAUSS_PATTERSON, GAUSS_LEGENDRE,
       ...
       GAUSS_JACOBI, GOLUB_WELSCH, GENZ_KEISTER, NEWTON_COTES };
