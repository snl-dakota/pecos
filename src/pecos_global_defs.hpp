...
enum { NO_TARGET=0,
       CDV_LWR_BND, CDV_UPR_BND, DDRIV_LWR_BND, DDRIV_UPR_BND,
       //DDSIV_VALUES, DDSSV_VALUES, DDSRV_VALUES,
       N_MEAN, N_STD_DEV, N_LWR_BND, N_UPR_BND, N_LOCATION, N_SCALE,
       ...
       BE_ALPHA, BE_BETA, BE_LWR_BND, BE_UPR_BND,
       GA_ALPHA, GA_BETA, IGA_ALPHA, IGA_BETA,
       ...
       H_PT_INT_PAIRS, H_PT_STR_PAIRS, H_PT_REAL_PAIRS,
       CIU_BASIC_PROBS, DIU_BASIC_PROBS,
       DUSIV_VALUES_PROBS, DUSSV_VALUES_PROBS, DUSRV_VALUES_PROBS,
       CSV_LWR_BND, CSV_UPR_BND, DSRIV_LWR_BND, DSRIV_UPR_BND };
       //DSSIV_VALUES, DSSSV_VALUES, DSSRV_VALUES };
