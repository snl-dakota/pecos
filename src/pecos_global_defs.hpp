...
enum { NO_TYPE=0, CONTINUOUS_DESIGN, STD_NORMAL, NORMAL, BOUNDED_NORMAL,
       ...
       GAMMA, GUMBEL, FRECHET, WEIBULL, HISTOGRAM_BIN, HISTOGRAM_POINT,
...
enum { QUADRATURE, CUBATURE, COMBINED_SPARSE_GRID, HIERARCHICAL_SPARSE_GRID,
       ...
       LEAST_ANGLE_REGRESSION, ORTHOG_LEAST_INTERPOLATION };
...
enum { DEFAULT_BASIS=0, TENSOR_PRODUCT_BASIS, TOTAL_ORDER_BASIS, ADAPTED_BASIS,
