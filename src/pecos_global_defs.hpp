...
enum { CONTINUOUS_DESIGN, STD_NORMAL, NORMAL, BOUNDED_NORMAL, LOGNORMAL,
       BOUNDED_LOGNORMAL, STD_UNIFORM, UNIFORM, LOGUNIFORM, TRIANGULAR,
       STD_EXPONENTIAL, EXPONENTIAL, STD_BETA, BETA, STD_GAMMA, GAMMA, GUMBEL,
       FRECHET, WEIBULL, HISTOGRAM_BIN, HISTOGRAM_POINT, CONTINUOUS_INTERVAL,
...
enum { INTERPOLATION_OF_PRODUCTS, PRODUCT_OF_INTERPOLANTS_FAST,
       PRODUCT_OF_INTERPOLANTS_FULL };
